...
function PostsDAO(db) {
    ...
    this.incrementLikes = function(permalink, comment_ordinal, callback) {
      ...
      //  callback(Error("incrementLikes NYI"), null);
        ...
        var likes ;
		likes = post.comments[comment_ordinal].num_likes;
		var author = post.comments[comment_ordinal].author;
		if(likes == null)
		{
			likes = 0;
		}
		likes = likes +1;
		var comment = {
			author: post.comments[comment_ordinal].author,
		body :  post.comments[comment_ordinal].body,
		num_likes : likes ,
		comment_ordinal : comment_ordinal
		};
		// likes = 4;
	//	var selector = {};
		  var selector = 'comments.author'  ;
		
	 console.log("comment_ordinal" + comment_ordinal + "likes"+ likes);
	 console.log("author" + author );
		 

		 posts.update({'permalink': permalink, 'comments.author' :author }, {$set: {"comments.$": comment}}, function(err, numModified) {
            "use strict";
